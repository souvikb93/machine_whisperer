...
export const STRINGS = {
  ...
  fix: {
    ...
    machineFix:    { en: "Machine Fixed!",         de: "Maschine repariert!" },
    didntFix:      { en: "Didn’t fix it",     de: "Nicht behoben" },
    stepDone:      { en: "Step Done — Continue", de: "Schritt erledigt — Weiter" },
    error:         { en: "Error:",                 de: "Fehler:" },
    min:           { en: "min",                    de: "Min." },
  },
  ...
  // ── Scan screen ──────────────────────────────────────────────────────────
  scan: {
    title:           { en: "Scan HMI",                          de: "HMI scannen" },
    cameraUnavail:   { en: "Camera unavailable",                de: "Kamera nicht verfügbar" },
    alignPrompt:     { en: "Align HMI screen within the frame", de: "HMI-Bildschirm im Rahmen ausrichten" },
    scanning:        { en: "Scanning…",                    de: "Wird gescannt…" },
    ctaScan:         { en: "Scan HMI for Diagnosis",            de: "HMI für Diagnose scannen" },
    preparing:       { en: "Preparing Diagnosis",               de: "Diagnose wird vorbereitet" },
    pulling:         { en: "Pulling context from all sources…", de: "Kontext aus allen Quellen wird geladen…" },
    ...
    machineDetected: { en: "Machine Detected",                  de: "Maschine erkannt" },
    confident:       { en: "% confident",                       de: "% sicher" },
    fieldMachine:    { en: "Machine",                           de: "Maschine" },
    fieldErrorCode:  { en: "Error Code",                        de: "Fehlercode" },
    fieldErrorText:  { en: "Error Text",                        de: "Fehlertext" },
    ctaStart:        { en: "Start Diagnosis →",            de: "Diagnose starten →" },
